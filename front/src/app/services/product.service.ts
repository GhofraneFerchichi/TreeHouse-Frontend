...
export class ProductService {
  ...
  baseUrl = 'http://localhost:9004/api/v1/mproduits';
  panierUrl = 'http://localhost:9005/api/v1/mpanier';
  private apiUrl = 'http://localhost:9009/api/v1/mcommandes'; // Update with your backend URL
